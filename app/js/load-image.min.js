(function(e){
    ...
    for(t in e)e.hasOwnProperty(t)&&(i[t]=e[t]);switch(e.orientation){
        case 2:
...
for(a in t)t.hasOwnProperty(a)&&(i[t[a]]=a);e.ExifMap.prototype.getAll=function(){
    var e,i,a={};
    
    for(e in this)this.hasOwnProperty(e)&&(i=t[e],i&&(a[i]=this.getText(i)));return a
    }
});